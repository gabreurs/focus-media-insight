export const slides = [
  ...
  { id: "direcao", label: "Direção narrativa" },
  { id: "fio", label: "Fio narrativo" },
  { id: "calendario", label: "Calendário" },
  { id: "formatos", label: "Formatos" },
  { id: "entregaveis", label: "Entregáveis" },
  { id: "validar", label: "A validar" },
  { id: "alinhamento", label: "Próximo alinhamento" },
  { id: "marqo", label: "Studio Marqo" },
];

export const fioNarrativo = [
  {
    n: "01",
    etapa: "Chegada",
    texto:
